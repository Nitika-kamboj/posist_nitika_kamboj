...
void input(int head,vector<struct node*> headnodes)
{
    ...
    string name,password,algo="nitika";
    float value;
    int id;
    cout<<"Enter your name:\n  Enter your id:\n Enter Value :\n Enter ypur password :<<endl";
...
int main()
{
    ...
    cout<<"3 : create new node to any set of the node\n";
    cout<<"4 : create an algorithm to encrypt data\n";
    cout<<"5 : verify owner with the key\n";
    cout<<"6 : break any node\n";
    cout<<"7 : change owner of the node\n";
    cout<<"8 : longest chain of main node\n";
    cout<<"9 : longest chain of sub node among set of node\n";
    cout<<"10 : merge two sets\n";
    cout<<"11 : finish and clear all data";
